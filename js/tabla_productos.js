const { createApp } = Vue
  ...
  createApp({
    data() {
      return {
        url:"https://web2023.pythonanywhere.com/inscripciones", // Retorna todos los registro de la tabla inscripciones
        productos:[],
        error:false,
        cargando:true
      }
    ...
    methods: {
        ...
        eliminar(id) {
            ...
            const url = 'https://web2023.pythonanywhere.com/borrar/'+id;
            var options = {
                method: 'DELETE',
